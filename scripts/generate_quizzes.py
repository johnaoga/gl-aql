...
QUIZ_TITLES = {
    'quiz1_qualite_iso': 'Quiz 1 : Qualité & norme ISO/IEC 9126',
    'quiz2_mesures': 'Quiz 2 : Mesures & échelles',
    'quiz3_metriques': 'Quiz 3 : Métriques logicielles',
}
...
def main():
    # Configuration
    repo = os.environ.get('GITHUB_REPOSITORY', 'johnaoga/gl-aql')
